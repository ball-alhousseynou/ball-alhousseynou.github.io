...
---
Bienvenue sur mon portfolio Data Science. Je suis un ingénieur Data Science avec une expérience en NLP, Machine Learning, Deep Learning, analyse exploratoire et production de pipelines data.

- 10+ projets open source
- Spécialisation : OCR, NER, clusterisation, recommandation et analyse de documents
- Stack : Python, Pandas, Scikit-Learn, XGBoost, TensorFlow/PyTorch, NLP (transformers), Docker
...
- Détection automatique de la structure (tables, en-têtes) dans des fichiers PDF et images
...
<em>Technologies : Python, SentenceTransformers, Elasticsearch</em>
...
<em>Technologies : Python, Pandas, Scikit-Learn, XGBoost</em>
...
<em>Technologies : Python, Scikit-Learn, XGBoost</em>
...
<em>Technologies : Python, Selenium, APIs</em>
